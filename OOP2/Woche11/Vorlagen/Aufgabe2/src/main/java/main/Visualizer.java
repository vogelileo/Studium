...
public class Visualizer extends Application {
    ...
    public void start(Stage stage) {
        ...
        /*
            Replace 'HashFunctions::hashCode' with your own hash function you want to visualize
         */
        lineChart.getData().add(getGraphFromHashFunction(HashFunctions::hashCode, "HashFunction1", 4));
