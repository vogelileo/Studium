...
public class HashFunctionEvaluator<K> {
    ...
    public static void main(String[] args) {
        ...
        /*
            Replace this with your own function main.HashFunctions::hashCode
         */
        evaluator.checkForCollisions(HashFunctions::hashCode3, 4);
        /*
            Sha256 Hash function for cryptography
         */
//        main.HashFunctionEvaluator<String> shaEvaluator = new main.HashFunctionEvaluator<>();
